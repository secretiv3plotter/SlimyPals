...
export const FOOD_FACTORY_FRAME_HEIGHT = 115
export const FOOD_FACTORY_FRAME_WIDTH = 64
export const FOOD_FACTORY_SCALE = 1
export const FOOD_FACTORY_CLICK_ALPHA_THRESHOLD = 100
...
export const SUMMONING_GROUND_FRAME_COUNT = 20
export const SUMMONING_GROUND_FRAME_HEIGHT = 113
export const SUMMONING_GROUND_FRAME_WIDTH = 64
