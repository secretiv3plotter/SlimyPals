...
export const FOOD_FACTORY_COLUMNS_FROM_FENCE = 2.5
...
export const SLIME_FRAME_HEIGHT = 44
export const SLIME_FRAME_WIDTH = 47
export const SLIME_SCALE = 0.72
export const SUMMONING_GROUND_COLUMNS_FROM_FENCE = -0.2
export const SUMMONING_GROUND_FRAME_COUNT = 15
export const SUMMONING_GROUND_FRAME_HEIGHT = 128
export const SUMMONING_GROUND_FRAME_WIDTH = 128
